...
val colorPrimaryLight @Composable get()= colorResource(id = R.color.color_primary_light)
...
val colorSecondaryLight @Composable get()= colorResource(id = R.color.color_secondary_light)
val colorSecondaryDark @Composable get()= colorResource(id = R.color.color_secondary_dark)
...
val colorBlue @Composable get()= colorResource(id = R.color.widget_color_blue)
val colorGreen @Composable get()= colorResource(id = R.color.widget_color_green)
val colorYellow @Composable get()= colorResource(id = R.color.widget_color_yellow)
